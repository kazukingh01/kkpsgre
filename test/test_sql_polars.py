...
if __name__ == "__main__":
    ...
    db_psgre = DBConnector("99.99.0.2", port=5432,  dbname=DBNAME, user="postgres", password="postgres", dbtype="psgre", max_disp_len=5000, use_polars=True)
    db_mysql = DBConnector("99.99.0.3", port=3306,  dbname=DBNAME, user="mysql",    password="mysql",    dbtype="mysql", max_disp_len=5000, use_polars=True)
    db_mongo = DBConnector("99.99.0.4", port=27017, dbname=DBNAME, user="root",     password="secret",   dbtype="mongo", max_disp_len=5000, use_polars=True)
